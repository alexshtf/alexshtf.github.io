...
- Try interpolating
- Clarify the contrast between interpolation and universality
- Update experiments
...
The notebook for reproducing all the results is [here](https://github.com/alexshtf/alexshtf.github.io/blob/master/assets/specrum_power_intro.ipynb). Feel free to deploy it to Colab and play ith it.
